...
let Messages = {
        ...
        success: {
            ...
            CANCELLATION_FEE: "O cancelamento desta viagem pode causar cobrança de taxa no valor de Kz {{fee}}",
            CANCELLATION_FEE_DRIVER_TO_CLIENT: "O cancelamento desta viagem pode causar cobrança ao passageiro no valor de Kz {{fee}}, nossa equipe avaliará o motivo do cancelamento e em caso de má conduta você poderá ser punido.",
        },
        push: {
            ...
            approvePoddValidation: "Parabéns {{driver}}! Você agora é cooperado, seu número é {{enrollment}}.",
            ...
            cpfInvalid: "Seu cadastro foi negado devido ao Bilhete de Identificação.",
        ...
        statementValues: {
            ...
            withdraw: {
                ...
                description2: "Saldo disponíbvel"
            },
            adminAction: {
        ...
        error: {
            ...
            ERROR_EXISTS_CPF: "Este Bilhete de Identificação já esta sendo utilizado",
            ...
            ERROR_CPF_INVALID: {code: 639, message: "O Bilhete de Identificação digitado é inválido."},
            ...
            ERROR_MIN_FOR_WITHDRAW: {code: 705, message: "O valor mínimo de saque é de Kz5,00"},
            ERROR_TWO_DRIVERS_SAME_CPF: {
                code: 706,
                message: "Você possui outro cadastro de motorista com esse Bilhete de Identificação"
            },
